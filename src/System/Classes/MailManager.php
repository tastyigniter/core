...
class MailManager
{
    ...
    protected function registerBladeDirectives()
    {
        Blade::directive('partial', function ($expression) {
            return "<?php \Igniter\System\Classes\MailManager::instance()->startPartial({$expression}); ?>";
        });

        Blade::directive('endpartial', function () {
            return "<?php echo \Igniter\System\Classes\MailManager::instance()->renderPartial(); ?>";
        });
    }
