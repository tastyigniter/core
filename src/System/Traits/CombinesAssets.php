...
trait CombinesAssets
{
    ...
    protected function initCombiner()
    {
        ...
        $this->useMinify = config('igniter.system.enableAssetMinify', null);
        $this->storagePath = storage_path('igniter/combiner/data');
        $this->assetsCombinerUri = config('igniter.system.assetsCombinerUri', '/_assets');

        if (Igniter::runningInAdmin())
            $this->assetsCombinerUri = config('igniter.system.adminUri', '/admin').$this->assetsCombinerUri;
