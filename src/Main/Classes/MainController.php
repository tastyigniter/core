...
use Igniter\Main\Template\Extension\BladeExtension as MainBladeExtension;
...
use Igniter\System\Template\Extension\BladeExtension as SystemBladeExtension;
...
class MainController extends BaseController
{
    ...
    public function __construct($theme = null)
    {
        ...
        if (!$this->theme)
            throw new ApplicationException(Lang::get('igniter.igniter::main.not_found.active_theme'));
    ...
    public function renderComponent($name, array $params = [], $throwException = true)
    {
        ...
        if (!$componentObj = $this->findComponentByAlias($name)) {
            $this->handleException(sprintf(lang('igniter::main.not_found.component'), $name), $throwException);
