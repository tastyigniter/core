...
use Igniter\Admin\Middleware\LogUserLastSeen;
...
class AdminServiceProvider extends AppServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->publishes([
            $this->root.'/resources/dist' => public_path('vendor/igniter/admin'),
        ], 'igniter-assets');

        $this->defineEloquentMorphMaps();
        $this->defineAuthGuardAndProvider();
    ...
    protected function registerSingletons()
    {
        ...
        App::singleton('admin.auth', function () {
            return resolve('auth')->guard('admin');
        });
    ...
    protected function registerAssets()
    {
        Assets::registerCallback(function (Assets $manager) {
            $manager->registerSourcePath(public_path('vendor/igniter/admin'));
    ...
    protected function defineEloquentMorphMaps()
    {
        Relation::morphMap([
            ...
            'customer_groups' => \Igniter\Admin\Models\CustomerGroup::class,
    ...
    protected function defineAuthGuardAndProvider()
    {
        Auth::extend('igniter', function ($app, $name, array $config) {
            $guard = new Classes\UserGuard($name,
        ...
        Auth::provider('igniter', fn() => new Classes\UserProvider);
    }
}
