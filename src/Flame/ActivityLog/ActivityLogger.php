...
class ActivityLogger
{
    ...
    /** @var \Igniter\Flame\Auth\SessionGuard */
    protected $sendTo;
    ...
    public function __construct(Application $app)
    {
        ...
        $this->logName = $app['config']->get('igniter.system.activityLogName', 'default');
        $this->logEnabled = $app['config']->get('igniter.system.activityLogEnabled', true);
    }
