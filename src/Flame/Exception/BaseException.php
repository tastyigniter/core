...
class BaseException extends Exception
{
    ...
    /**
     * @var \stdClass Cached code information for highlighting code.
     */
    protected $highlight;
     ...
     * @return \stdClass Highlight information as an array, the following keys are supplied:
