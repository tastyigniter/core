...
class Reservations extends \Igniter\Admin\Classes\AdminController
{
    public $implement = [
        ...
        \Igniter\Admin\Controllers\Actions\CalendarController::class,
        \Igniter\Admin\Controllers\Actions\FormController::class,
        \Igniter\Admin\Controllers\Actions\AssigneeController::class,
    ...
    public function index_onDelete()
    {
        ...
        return $this->asExtension(\Igniter\Admin\Controllers\Actions\ListController::class)->index_onDelete();
    }
    ...
    public function edit_onDelete()
    {
        ...
        return $this->asExtension(\Igniter\Admin\Controllers\Actions\FormController::class)->edit_onDelete();
    }
