...
class AssigneeController extends ControllerAction
{
    ...
    {
        if ($this->controller->isClassExtendedWith(\Igniter\Admin\Controllers\Actions\ListController::class)) {
    ...
    {
        if ($this->controller->isClassExtendedWith(\Igniter\Admin\Controllers\Actions\FormController::class)) {
