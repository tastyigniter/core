...
class Payment extends Model
{
     ...
     * @param \Igniter\Admin\Models\Customer $customer Specifies customer to find a profile for.
     ...
     * @param \Igniter\Admin\Models\Customer $customer Specifies customer to initialize a profile for.
    ...
    public function deletePaymentProfile($customer)
    {
        ...
        if (!$profile) {
            throw new ApplicationException(lang('igniter::admin.customers.alert_customer_payment_profile_not_found'));
        }
