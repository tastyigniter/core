...
$config['list']['filter'] = [
    'search' => [
        'prompt' => 'lang:igniter::admin.customers.text_filter_search',
...
$config['list']['columns'] = [
    ...
    'impersonate' => [
        ...
        'attributes' => [
            ...
            'data-request-confirm' => 'igniter::admin.customers.alert_impersonate_confirm',
        ],
    ],
    'full_name' => [
        'label' => 'lang:igniter::admin.customers.column_full_name',
        'type' => 'text',
    ...
    'telephone' => [
        'label' => 'lang:igniter::admin.customers.column_telephone',
        'type' => 'text',
    ],
    'status' => [
...
$config['form']['toolbar'] = [
    'buttons' => [
        ...
        'impersonate' => [
            'label' => 'lang:igniter::admin.customers.text_impersonate',
            'class' => 'btn btn-default',
            'data-request' => 'onImpersonate',
            'data-request-confirm' => 'igniter::admin.customers.alert_impersonate_confirm',
            'context' => ['edit'],
...
$config['form']['tabs'] = [
    'defaultTab' => 'lang:igniter::admin.customers.text_tab_general',
    'fields' => [
        'first_name' => [
            'label' => 'lang:igniter::admin.customers.label_first_name',
            'type' => 'text',
            'span' => 'left',
        ],
        'last_name' => [
            'label' => 'lang:igniter::admin.customers.label_last_name',
            'type' => 'text',
            'span' => 'right',
        ],
        'email' => [
        ...
        'telephone' => [
            'label' => 'lang:igniter::admin.customers.label_telephone',
            'type' => 'text',
            'span' => 'right',
        ],
        'send_invite' => [
            'label' => 'lang:igniter::admin.customers.label_send_invite',
            'type' => 'checkbox',
            'context' => 'create',
            'default' => true,
            'options' => [],
            'placeholder' => 'lang:igniter::admin.customers.help_send_invite',
        ],
        'password' => [
            'label' => 'lang:igniter::admin.customers.label_password',
            'type' => 'password',
            'span' => 'left',
            'comment' => 'lang:igniter::admin.customers.help_password',
            'trigger' => [
                'action' => 'show',
                'field' => 'send_invite',
                'condition' => 'unchecked',
        ...
        '_confirm_password' => [
            'label' => 'lang:igniter::admin.customers.label_confirm_password',
            'type' => 'password',
            'span' => 'right',
            'trigger' => [
                'action' => 'show',
        ...
        'customer_group_id' => [
            'label' => 'lang:igniter::admin.customers.label_customer_group',
            'type' => 'relation',
            'span' => 'left',
            'relationFrom' => 'group',
            'nameFrom' => 'group_name',
        ...
        'newsletter' => [
            'label' => 'lang:igniter::admin.customers.label_newsletter',
            'type' => 'switch',
            'on' => 'lang:igniter::admin.customers.text_subscribe',
            'off' => 'lang:igniter::admin.customers.text_un_subscribe',
            'span' => 'left',
            'cssClass' => 'flex-width',
        ],
        'status' => [
        ...
        'addresses' => [
            'tab' => 'lang:igniter::admin.customers.text_tab_address',
            'type' => 'repeater',
            'form' => 'address',
        ],
        'orders' => [
            'tab' => 'lang:igniter::admin.customers.text_tab_orders',
            'type' => 'datatable',
        ...
        'reservations' => [
            'tab' => 'lang:igniter::admin.customers.text_tab_reservations',
            'type' => 'datatable',
            'context' => ['edit', 'preview'],
            'useAjax' => true,
