...
$config['list']['columns'] = [
    ...
    'customer_count' => [
        'label' => 'lang:igniter::admin.customer_groups.column_customers',
        'type' => 'number',
        'sortable' => false,
    ],
    'approval' => [
        'label' => 'lang:igniter::admin.customer_groups.label_approval',
        'type' => 'switch',
    ],
    'customer_group_id' => [
...
$config['form']['fields'] = [
    ...
    'approval' => [
        'label' => 'lang:igniter::admin.customer_groups.label_approval',
        'type' => 'switch',
        'comment' => 'lang:igniter::admin.customer_groups.help_approval',
    ],
    'description' => [
