...
+function ($) {
    ...
    var DashboardContainer = function (element, options) {
        ...
        this.$el = $(element)
        this.$toolbar = $('[data-container-toolbar]', this.$el)
    ...
    DashboardContainer.DATE_RANGE_DEFAULTS = {
        ...
        locale: {
            format: DashboardContainer.DEFAULTS.dateRangeFormat,
        }
    }
    ...
    DashboardContainer.prototype.onSortWidgets = function () {
        var aliases = [],
            sortOrders = [],
            self = this
        ...
        $.request(self.options.alias + '::onSetWidgetPriorities', {
            data: {
                'aliases': aliases,
    ...
    DashboardContainer.prototype.onDateRangeSelected = function (start, end) {
