        ...
        <div class="toolbar-item pb-3 pb-lg-0">
            <div class="btn-group">
                ...
                >
                    ...
                    <div
                        id="{{ $self->getId('folder-tree') }}"
                        data-control="folder-tree"
                        class="dropdown-menu"
                    >{!! $self->makePartial('mediamanager/folder_tree') !!}</div>
                </div>
                <button
        ...
        <div class="toolbar-item">
            <div class="input-group">
                <div class="dropdown mr-2">
                    ...
                    {!! $self->makePartial('mediamanager/filters', ['filterBy', $filterBy]) !!}
                </div>
                ...
                <div class="dropdown mr-2">
                    ...
                    {!! $self->makePartial('mediamanager/sorting', ['sortBy', $sortBy]) !!}
                </div>
                ...
                @endunless
                {!! $self->makePartial('mediamanager/search') !!}
            </div>
        </div>
    </div>
</div>
