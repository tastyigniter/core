...
>
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">{{ sprintf(lang('igniter::system.updates.text_popular_title'), ucwords(str_plural($itemType))) }}</h4>
        ...
        <div class="modal-footer">
            ...
            >@lang('igniter::system.updates.button_install')</button>
        </div>
    </div>
    {!! form_close() !!}
</div>
