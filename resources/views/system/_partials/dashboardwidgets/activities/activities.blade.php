<div class="dashboard-widget widget-activities">
    ...
    <div class="row">
        <div class="list-group list-group-flush w-100">
            ...
            @empty
                <div class="list-group-item bg-transparent">@lang('igniter::admin.dashboard.text_no_activity')</div>
            @endforelse
        </div>

        <div class="text-right pt-3 px-3 w-100">
            <a href="{{ admin_url('activities') }}">
                @lang('igniter::admin.text_see_all_activity')&nbsp;<i class="fa fa-arrow-right"></i>
            </a>
        </div>
    </div>
</div>
