<div
    ...
    data-sortable-container="#{{ $self->getId('container-list') }}"
>
    <div
        id="{{ $self->getId('container-toolbar') }}"
        class="toolbar dashboard-toolbar btn-toolbar"
        data-container-toolbar>
        {!! $self->makePartial('widget_toolbar') !!}
    </div>

    <div id="{{ $self->getId('container') }}" class="dashboard-widgets page-x-spacer">
