<div class="modal-dialog modal-dialog-scrollable">
    ...
    <div class="modal-content">
        <div class="modal-header">
            <h4 class="modal-title">{{ sprintf(lang('igniter::admin.list.setup_title'), lang($self->getConfig('title')))}}</h4>
        ...
        <div class="modal-footer progress-indicator-container">
            <button
                ...
                data-request="{{ $self->getEventHandler('onResetSetup')}}"
            ...
            <button
                ...
                data-request="{{ $self->getEventHandler('onApplySetup')}}"
