                        ...
                        <div class="col-md-9">
                            @isset($fields['order_menus'])
                                <div class="card bg-light shadow-sm mb-2 p-2">
                                    {!! $self->renderFieldElement($fields['order_menus']) !!}
                                </div>
                            @endisset
                            @isset($fields['order_details'])
                                <div class="card bg-light shadow-sm mb-2 p-2">
                                    {!! $self->renderFieldElement($fields['order_details']) !!}
                                </div>
                            @endisset
                        </div>
                        <div class="col-md-3 px-md-0">
                            @if($formModel->comment)
                                <div class="card bg-light shadow-sm mb-2">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('igniter::admin.orders.label_comment')</h5>
                            ...
                            <div class="card bg-light shadow-sm mb-2">
                                @isset($fields['customer'])
                                    {!! $self->renderFieldElement($fields['customer']) !!}
                                @endisset
                            </div>
                            @isset($fields['location'])
                                <div class="card bg-light shadow-sm mb-2">
                                    <div class="card-body">
                                        ...
                                        {!! $self->renderFieldElement($fields['location']) !!}
                                    </div>
                                </div>
                            @endisset
                        </div>
