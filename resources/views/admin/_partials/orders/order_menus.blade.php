<div class="table-responsive">
    <table class="table mb-0">
        <thead>
        <tr>
            <th width="65%" class="border-top-0">@lang('igniter::admin.orders.column_name_option')</th>
            <th class="text-center border-top-0">@lang('igniter::admin.orders.column_quantity')</th>
            <th class="text-left border-top-0">@lang('igniter::admin.orders.column_price')</th>
            <th class="text-right border-top-0">@lang('igniter::admin.orders.column_total')</th>
        </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                >
                    ...
                    @if ($total->code == 'subtotal')
                        <span class="text-muted">({{ $formModel->total_items }} @lang('igniter::admin.orders.label_total_items'))</span>
                    @endif
                </td>
