    ...
    >
        <div class="input-group">
            ...
            <select
                ...
                {!! $field->getAttributes() !!}
            >
                @if ($fieldPlaceholder = $field->placeholder ?: $self->emptyOption)
            ...
            @if ($showEditButton)
                ...
                ><i class="fa fa-pencil"></i>&nbsp;&nbsp;@lang($editLabel)&nbsp;@lang($self->formName)</button>
            @endif
            @if ($showDeleteButton)
                <button
                    type="button"
                    class="btn btn-outline-danger"
                    title="{{ lang($deleteLabel).' '.lang($self->formName) }}"
            ...
            @if ($showCreateButton)
                <button
                    ...
                    {!! ($self->previewMode) ? 'disabled="disabled"' : '' !!}
                ><i class="fa fa-plus"></i>&nbsp;&nbsp;@lang($addLabel)&nbsp;@lang($self->formName)</button>
            @endif
        </div>
    </div>
@endunless
